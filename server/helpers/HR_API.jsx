...
var getProductMetaData = (id) => {
  return axios.get(`http://ec2-204-236-148-204.us-west-1.compute.amazonaws.com:3000/reviews/meta?product_id=${id}`, {
    headers: headers
  });
}

var getProductReviews = (id, count, sort) => {
  return axios.get(`http://ec2-204-236-148-204.us-west-1.compute.amazonaws.com:3000/reviews?product_id=${id}&count=${count}&sort=${sort}`, {
    headers: headers
  });
}
...
var postProductReviews = (data) => {
  return axios.post(`http://ec2-204-236-148-204.us-west-1.compute.amazonaws.com:3000/reviews`, data, {
    headers: headers
  });
}

var updateReviewsHelpfulness = (id, data) => {
  return axios.put(`http://ec2-204-236-148-204.us-west-1.compute.amazonaws.com:3000/reviews/${id}/helpful`, data, {
    headers: headers
  });
};

var reportReview = (id, data) => {
  return axios.put(`http://ec2-204-236-148-204.us-west-1.compute.amazonaws.com:3000/reviews/${id}/report`, data, {
    headers: headers
  });
}
